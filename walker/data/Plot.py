...
reward_record=pickle.load(open("1record.p", "rb"))
reward_record_average=pickle.load(open("1average_record.p","rb"))
evaluation_reward_record=pickle.load(open( "1evaluation_record.p", "rb"))
