...
agent_leg = Agnent.create(agent='agent.json',environment=environment_single,exploration=exploration)
agent_foot = Agent.create(agent='agent.json',environment=environment_single,exploration=eploration)
