...
from gym.utils.draw import draw_grid, fill_cell, draw_circle, write_cell_text

logger = logging.getLogger(__name__)


class IronDome(gym.Env):
    """
    ...
    def __init__(self, grid_shape=(7, 7), n_agents=3, n_preys=3, prey_move_probs=(0.175, 0.175, 0.175, 0.175, 0.3),
                 penalty=-5, step_cost=-1, prey_capture_reward=50, max_steps=100):
        ...
        self._agent_view_mask = (7, 7)
        self.action_space = spaces.Discrete(4) # there are 5 options, left, right, up, down

        self.agent_pos = {_: None for _ in range(self.n_agents)}
        self.prey_pos = {_: None for _ in range(self.n_preys)}

        self._prey_alive = None
        self._predator_alive=None
        ...
        self.observation_space = spaces.Dict({"target1": spaces.Tuple(spaces.Discrete(7),spaces.Discrete(7)), "target2": spaces.Tuple(spaces.Discrete(7),spaces.Discrete(7)),"target3": spaces.Tuple(spaces.Discrete(7),spaces.Discrete(7)),
                                              "agent1": spaces.Tuple(spaces.Discrete(7),spaces.Discrete(7)), "agent2": spaces.Tuple(spaces.Discrete(7),spaces.Discrete(7)),"agent3": spaces.Tuple(spaces.Discrete(7),spaces.Discrete(7)),
                                              "control":spaces.Discrete(self.n_agents)
        })
